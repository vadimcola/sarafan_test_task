...
urlpatterns = [
    path('category/', CategoryList.as_view(), name='category_list'),  # Просмотр списка Категорий
    path('product/', ProductList.as_view(), name='product_list'),  # Просмотр списка Продуктов
